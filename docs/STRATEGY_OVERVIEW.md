...
- Indicators vote BUY, SELL, or NEUTRAL independently for each of 5 Solana markets
...
- **Market selection:** Agents choose which of the 5 markets to trade via a multi-market selector
...
4. EE-16 trades automatically across all 5 markets based on signal strength
...
4. Start EE-16 strategies with `startStrategy()`, selecting any combination of 5 markets
